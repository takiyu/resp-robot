...
bool GLWindow::shouldClose() {
    return glfw_inited && (glfwWindowShouldClose(this->window) == GL_TRUE);
}
...
void GLWindow::exit() { glfwTerminate(); }
...
void GLWindow::keyboardFunc(GLFWwindow* window, int key, int scancode,
                            int action, int mods) {
    GLWindow* that = static_cast<GLWindow*>(glfwGetWindowUserPointer(window));
